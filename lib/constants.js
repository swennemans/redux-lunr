...
/* Add an prepared index (for example on server) as search index */
var LUNR_LOAD_SEARCH_INDEX = _middlewareJs.SEARCH_LUNR + 'LOAD_SEARCH_INDEX';
exports.LUNR_LOAD_SEARCH_INDEX = LUNR_LOAD_SEARCH_INDEX;
var LUNR_LOAD_SEARCH_INDEX_SUCCESS = _middlewareJs.SEARCH_LUNR + 'LOAD_SEARCH_INDEX_SUCCESS ';

exports.LUNR_LOAD_SEARCH_INDEX_SUCCESS = LUNR_LOAD_SEARCH_INDEX_SUCCESS;
