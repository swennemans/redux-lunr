      ...
      return function (action) {
        ...
        switch (type) {
          case _constantsJs.LUNR_INDEX_DOCS:
            ...
            var docsSearchIndex = !needToMap ? addToIndex(_toIndex, options) : addToIndex(applyMapper(_toIndex, options.mapper), options);
          ...
          case _constantsJs.LUNR_INDEX_STATE:
            next(searchLunr);
            /* Create and save searchIndex */
            var stateSearchIndex = !needToMap ? addToIndex(getDataFromState(options, getState), options) : addToIndex(applyMapper(getDataFromState(options, getState), options.mapper), options);
